...
const Widget = ({dimensions,logo,title,figure}) => {
  return (
    <Flex height='200px' width='300px' backgroundColor='#fff' alignItems='center' padding='0 1rem' gap='2rem' boxShadow='rgba(0, 0, 0, 0.15) 1.95px 1.95px 2.6px' borderRadius='6px'>
