...
let featuredArr = [
  ...
  },
  {
    ...
    offer: "Upto 20% Off + Select your free serum ",
  ...
  },
  {
    ...
    offer: "Flat 15% Off + Additional 10% Off on 2",
    desc: "On Entire Range",
  },
  {
...
const Home = () => {
  ...
  return (
    <>
      ...
      <Box border="1px solid red" mt=".7rem" backgroundColor="#f3f3f3">
        <Text
          textAlign="center"
          fontSize="24px"
          fontWeight="normal"
        ...
        <Container height="95%">
          <Carousel className="w-80">
            {buyingGuidsArr.map((el) => (
              <Carousel.Item>
                <img className="d-block w-90" src={el} alt="First slide" />
              </Carousel.Item>
            ))}
          </Carousel>
        </Container>
